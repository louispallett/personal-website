    ...
    return (
        <>
            ...
            <div id="flex-center" className="gap-2.5 my-1.5">
                <div id="flex-center">
                    <a href="https://github.com/louispallett/odin-blog-api" target="_blank"><button className="github-repo">&gt; GitHub Repo &lt;</button></a>
                </div>
                <div id="flex-center">
                    <a href="https://son-blog.netlify.app/dashboard/articles/" target="_blank"><button className="live-site">&gt; Live Site &lt;</button></a>
                </div>
            </div>
        </>
    )
            ...
            <div className="flex flex-col gap-2.5 my-2.5">
                ...
                <ul className="list-disc ml-5 flex flex-col gap-2">
                    ...
                    <li>
                        ...
                        and then the <a href="https://cloudinary.com/" className="font-semibold text-lime-500 hover:text-lime-400 transition-all" >Cloudinary API</a> and module to upload the file to a cloudinary account. This would then return the source URL for the image, which
