        ...
        <>
            {welcome ? (
                <section id="flex-center" className="my-28 mb-48">
                    ...
                    >
                        <p className="text-center">Bash Script</p>
                    </div>
                </section>
            ) : (
    ...
    return (
        <>
                ...
                <div className="flex flex-col items-center md:items-end my-2.5">
                    <div className="flex items-center md:justify-end">
                        <div className="flex flex-col md:items-end">
                            <p className="language-subheaders"><b>Language</b></p>
            ...
            <div id="flex-center" className="gap-2.5 my-1.5">
                <div id="flex-center" className="my-2.5">
                    <a href="https://github.com/louispallett/manuscript_chapter_renaming" target="_blank"><button className="github-repo">&gt; GitHub Repo &lt;</button></a>
                </div>
            </div>
        </>
    )
