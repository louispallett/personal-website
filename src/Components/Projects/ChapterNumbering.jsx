    ...
    return (
        <section className="border-4 my-5 border-slate-800 dark:border-slate-100 text-slate-50 rounded-lg bg-indigo-600 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.2)]">
            <div className="p-2.5 sm:p-5">
                <h1 className="text-center text-xl sm:text-2xl my-2.5 font-montserrat">Chapter File Renamer - a Small Bash Script</h1>
                    ...
                    <div className="self-center">
                        <div className="flex items-center md:justify-end gap-2.5 my-1.5 sm:my-2.5">
                            <div className="flex flex-col sm:items-end">
                                <p className="text-xs sm:text-sm my-1.5"><b>Language</b></p>
                ...
                <div className="flex gap-2.5 my-2.5">
                    ...
                    <div className="flex flex-1 flex-col gap-2.5 text-sm sm:text-base">
                        ...
                        <div id="code" className="text-xs sm:text-sm px-5 p-2.5 text-slate-100 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.2)] my-2.5">
                            <pre>{code}</pre>
                        </div>
                        <p>
