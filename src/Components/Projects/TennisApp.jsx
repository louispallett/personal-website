                    ...
                    <div className="flex flex-col items-center md:items-end my-2.5">
                        <div className="flex items-center md:justify-end">
                            <div className="flex flex-col sm:items-end">
                                <p className="text-xs sm:text-sm my-1 text-center md:text-right"><b>Frontend</b></p>
                        ...
                        <div className="flex items-center md:justify-end">
                            <div className="flex flex-col sm:items-end">
                                <p className="text-xs sm:text-sm my-1 text-center md:text-right"><b>Backend</b></p>
                                <div className="flex gap-2.5 bg-indigo-600 p-1.5 rounded-md">
                        ...
                        <div className="flex items-center md:justify-end">
                            <div className="flex flex-col sm:items-end">
                                <p className="text-xs sm:text-sm my-1 text-center md:text-right"><b>Testing</b></p>
                                <div className="flex gap-2.5 bg-indigo-600 p-1.5 rounded-md">
                                    <svg viewBox="0 0 128 128" className="h-8 md:h-10">
