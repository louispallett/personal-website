        ...
        <section className="border-4 my-5 border-slate-800 dark:border-slate-100 text-slate-50 rounded-lg bg-indigo-600 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.2)]">
            <div className="p-2.5 sm:p-5">
                ...
                <div className="flex flex-col md:grid md:grid-cols-2">
                    ...
                    <div className="my-2.5 self-center">
                ...
                <div className="flex gap-2.5 justify-center items-center my-1.5">
                    <div className="flex justify-center">
                        <a href="https://github.com/louispallett/lowpal-tennis" target="_blank"><button className="p-1 px-1.5 bg-slate-900 text-slate-50 font-semibold rounded-md hover:bg-slate-700 transition-all">&gt; GitHub Repo &lt;</button></a>
                    </div>
