                ...
                <div className="p-2.5 sm:p-5">
                    ...
                    <div className="md:grid md:grid-cols-2">
                        ...
                        <div className="self-center">
                            <div className="flex items-center md:justify-end sm:text-lg gap-2.5 my-1.5 sm:my-2.5">
                                <p><b>Frontend</b>:</p>
                    ...
                    <div className="flex gap-2.5">
                        <div className="flex flex-col gap-2.5 text-sm sm:text-base">
                            ...
                            <p>
                                It's was a demanding and very 'hands-on' role to organise.
                            </p>
                            <p>
                                <i>Tennis Tournament by LowPal</i> fixes this issue by moving sign-up, viewing your next matches (with information regarding deadlines, match categories, players, and each player's contact details), and submitting your match results to an application. It also automates team selection, match creation, and participant allocation (to each match) via an algorithm written entirely by me.
                            </p>
                        </div>
                        <Fade delay={1000} triggerOnce>
                            <div id="project-img" className="hidden md:block">
    ...
    return (
        <div className="text-sm sm:text-base">
            ...
            <div className="flex gap-1.5 items-center">
                <p>I've written a (fairly long) walkthrough of this function. Click</p>
                {showLogic ? (
                    <button onClick={handleShowLogic} className="p-1 px-1.5 bg-lime-700 text-slate-50 font-semibold rounded-md hover:bg-lime-600 transition-all">here to hide it</button>
                ) : (
                    <button onClick={handleShowLogic} className="p-1 px-1.5 bg-lime-700 text-slate-50 font-semibold rounded-md hover:bg-lime-600 transition-all">here to show it</button>
                )}
            </div>
