            ...
            <div className="p-2.5 sm:p-5">
                ...
                <div className="md:grid md:grid-cols-2">
                    ...
                    <div className="flex items-center md:justify-end">
                        ...
                        <div className="flex items-center md:justify-end gap-2.5 my-1.5 sm:my-2.5">
                            <div className="flex flex-col sm:items-end">
                                <p className="text-xs sm:text-sm my-1"><b>Backend</b></p>
                                <div className="flex gap-2.5">
                        ...
                        <div className="flex items-center md:justify-end gap-2.5 my-1.5 sm:my-2.5">
                            <div className="flex flex-col sm:items-end">
                                <p className="text-xs sm:text-sm my-1"><b>Testing</b></p>
                                <svg viewBox="0 0 128 128" className="h-4 sm:h-6">
                ...
                <div className="flex gap-2.5 justify-center items-center">
                    <div className="flex justify-center my-2.5">
                        <a href="https://github.com/louispallett/lowpal-tennis" target="_blank"><button className="p-1 px-1.5 bg-slate-900 text-slate-50 font-semibold rounded-md hover:bg-slate-700 transition-all mt-5">GitHub Repo</button></a>
                    </div>
                    <div className="flex items-center">
                        <div className="flex justify-center my-2.5">
                            <a href="https://lowpal-tennis.netlify.app/users/sign-in" target="_blank"><button className="p-1 px-1.5 bg-lime-700 text-slate-50 font-semibold rounded-md hover:bg-lime-600 transition-all mt-5">Live Site</button></a>
                        </div>
                        <p><i>*</i></p>
                    </div>
                </div>
