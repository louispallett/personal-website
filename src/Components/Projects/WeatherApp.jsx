    ...
    return (
        <>
            ...
            <div id="flex-center" className="gap-2.5 my-1.5">
                <div id="flex-center">
                    <a href="https://github.com/louispallett/odin-weather-app" target="_blank"><button className="github-repo">&gt; GitHub Repo &lt;</button></a>
                </div>
                <div className="flex justify-center my-2.5">
                    <a href="https://louispallett.github.io/odin-weather-app/" target="_blank"><button className="live-site">&gt; Live Site &lt;</button></a>
                </div>
            </div>
        </>
    )
    ...
    return(
        <>
            ...
            <video
                ...
                data-setup="{}"
            >
                <source src="https://res.cloudinary.com/divlee1zx/video/upload/v1736093780/Kooha-2025-01-05-15-59-28_aqenw8.mp4" type="video/mp4" />
