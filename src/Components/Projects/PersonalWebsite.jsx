    ...
    return (
        <section className="border-4 my-5 border-slate-800 dark:border-slate-100 text-slate-50 rounded-lg bg-indigo-600 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.2)]">
            <div className="p-2.5 sm:p-5">
                <h1 className="text-center text-xl sm:text-2xl my-2.5 font-montserrat">This Website - my Personal Site</h1>
                <hr  className="mx-15 m-5"/>
                <div className="md:grid md:grid-cols-2">
                    <div>
                        <p className="my-1.5"><b>Type</b>: frontend</p>
                        <p><b>Short Description</b>: This is a website designed to presen
                    </div>
