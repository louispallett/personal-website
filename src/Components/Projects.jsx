            ...
            { welcome ? (
                ...
                <>
                    <div className="grid justify-center max-w-full">
                        <section id="flex-col-center" className="sm:p-5 sm:min-w-minArticle sm:max-w-maxArticle dark:text-slate-100">
                            <Zoom triggerOnce>
        ...
        <Link to="lowpal-tennis">
            <section className="project-card-container">
                <div className="p-2.5 sm:p-5">
                    <h1 className="header-bold-center">Tennis Tournament Application</h1>
                    ...
                    <div>
                    <p className="font-semibold italic text-center my-1.5 text-sm">This is my largest application with real-world usage. It utilises a majority of the skills and knowledge I've built up over the last 18 months. If there's a single applciation of mine you want to look at, it should be this one!</p>
                    ...
                    <div className="mt-5">
                        <div id="flex-center" className="gap-2.5 my-2.5">
...
function BlogCard() {
    return (
        <Link to="blog-api">
            <section className="project-card-container">
                <div className="p-2.5 sm:p-5">
                    <h1 className="header-bold-center">Terminally Locked</h1>
                    <Fade delay={250} triggerOnce>
                        <div id="flex-center">
                    ...
                    <div>
                        <p className="my-1.5"><b>Type</b>: Local Terminal Application</p>
                        <p><b>Short Description</b>: <i>Terminally Locked</i> is a super light-weight password manager which runs locally on your machine, written in C++.</p>
                    </div>
                    <div className="mt-5">
                        <div id="flex-center" className="gap-2.5 my-2.5">
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/cplusplus/cplusplus-original.svg" className="h-8 md:h-10" />
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/cmake/cmake-original.svg" className="h-8 md:h-10"/>
                        </div>
                    </div>
                </div>
            </section>
...
//             <section className="project-card-container">
//                 <div className="p-2.5 sm:p-5">
//                     <h1 className="header-bold-center">SON Blog - A Newspaper Application</h1>
//                     <Fade delay={250} triggerOnce>
//                         <div id="flex-center">
//                             <img className="w-32" src={sonImg} alt="" />
//                         </div>
...
function ChapterNumberingCard() {
    return (
        <Link to="chapter-numbering">
            <section className="project-card-container">
                <div className="p-2.5 sm:p-5">
                    <h1 className="header-bold-center">Chapter File Renamer - a Small Bash Script</h1>
                    <Fade delay={250} triggerOnce>
                        <div id="flex-center">
...
function WeatherAppCard() {
    return (
        <Link to="weather-app">
            <section className="project-card-container">
                <div className="p-2.5 sm:p-5">
                    <h1 className="header-bold-center">YAWA - Yet Another Weather App</h1>
                    <Fade delay={250} triggerOnce>
                        <div id="flex-center">
            ...
            <div className="p-2.5 sm:p-5">
                ...
                <ul className="list-disc ml-8 my-2.5">
                    <li className="my-2.5">
                        ...
                        <div id="flex-col-center" className="gap-2.5 ml-4">
                            <p>
                            ...
                            <div id="flex-center">
                                <a href="https://github.com/louispallett/odin-inventory-application" target="_blank"><button className="github-repo">&gt; GitHub Repo &lt;</button></a>
                            </div>
                        </div>
                    </li>
                    <li className="my-2.5">
                        ...
                        <div id="flex-col-center" className="gap-2.5 ml-4">
                            ...
                            <div id="flex-center">
                                <a href="https://github.com/louispallett/knight-travails" target="_blank"><button className="github-repo">&gt; GitHub Repo &lt;</button></a>
                            </div>
                        </div>
                    </li>
                </ul>
