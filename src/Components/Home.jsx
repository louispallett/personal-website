                    ...
                    <section className="flex justify-center items-center my-10 md:mb-48 md:my-36 dark:text-slate-100 max-w-full">
                        <div className="flex flex-col sm:flex-row items-center gap-5">
                            ...
                            <div>
                                ...
                                <p id="name4" className="relative text-xl sm:text-2xl md:text-4xl font-mania text-right py-5">FullStack Engineer</p>
                            </div>
                        </div>
                    </section>
    ...
    return (
        <section ref={targetElement} className="flex flex-col items-center p-3.5 ml-2.5 bg-lime-500 bg-opacity-70 dark:bg-indigo-700 rounded-ss-2xl lg:rounded-ss-full shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.2)]">
            <section className="lg:pl-52 max-w-maxArticle dark:text-slate-100">
                ...
                <p className="my-2.5">
                    Based in the city of Bristol, UK, I am a History graduate and self-taught fullstack engineer. 
                </p>
                <p className="my-2.5">
            ...
            <section className="dark:text-slate-100 flex flex-col items-center">
                ...
                <Fade cascade damping={0.25} triggerOnce delay={100} >
                    ...
                    <fieldset className="language-container">
                        ...
                        <div onClick={() => setIsOpen("bootstrap")}>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bootstrap/bootstrap-original.svg" />
                            <p>Bootstrap</p>
                        </div>
                        <div onClick={() => setIsOpen("css")}>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original.svg" />
                            <p>CSS</p>
                        </div>
                        <div onClick={() => setIsOpen("html")}>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg"/>
                            <p>HTML</p>
                        </div>
                        <div onClick={() => setIsOpen("javascript")}>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg" />
                            <p>JavaScript</p>
                        </div>
                        <div onClick={() => setIsOpen("npm")}>
                ...
                <Fade cascade damping={0.25} triggerOnce delay={100} >
                    ...
                    <fieldset className="language-container">
                        ...
                        <div onClick={() => setIsOpen("mongodb")}>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/mongodb/mongodb-original.svg" />
                            <p>MongoDB</p>
                        </div>
                        <div onClick={() => setIsOpen("nodejs")}>
                            <svg viewBox="0 0 128 128">
                ...
                <Fade cascade damping={0.25} triggerOnce delay={100} >
                    ...
                    <fieldset className="language-container">
                        ...
                        <div onClick={() => setIsOpen("c")}>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/c/c-original.svg"/>
                            <p className="">C</p>
                        </div>
                        <div onClick={() => setIsOpen("cpp")}>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/cplusplus/cplusplus-original.svg"/>
                            <p className="">C</p>
                        </div>
                        <div onClick={() => setIsOpen("git")}>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg"/>
                            <p>Git</p>
                        </div>
                        <div onClick={() => setIsOpen("python")}>
                            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/python/python-original.svg"/>
                            <p>Python</p>
                        </div>
                        <div onClick={() => setIsOpen("jest")}>
                            <svg viewBox="0 0 128 128">
